 ...
 */
	...
	define('CO_USUARIO_SOLICITANTE', 'co_usuario_solicitante');
	define('CO_USUARIO_STATUS', 'co_usuario_status');
	...
	define('CO_CODIGO_LIVRO', 'co_codigo_livro');
	define('DS_CODIGO_LIVRO', 'ds_codigo_livro');
	define('CO_LIVRO', 'co_livro');
	...
	define('DT_RESERVA', 'dt_reserva');
	define('DT_EMPRESTIMO', 'dt_emprestimo');
	define('DT_DEVOLUCAO', 'dt_devolucao');
	...
	define('NO_EDITORA', 'no_editora');
	define('NO_AUTOR', 'no_autor');
	define('DS_OBSERVACAO', 'ds_observacao');
	define('NU_ANO_PUBLICACAO', 'nu_ano_publicacao');
	define('NU_PAGINAS', 'nu_paginas');
	define('NU_ISBN', 'nu_isbn');
	define('NU_EDICAO', 'nu_edicao');
	define('DS_FOTO_CAPA', 'ds_foto_capa');
	define('DS_PALAVRAS_CHAVE', 'ds_palavras_chave');
	...
	define('CO_TAREFA', 'co_tarefa');
	define('DT_CONCLUSAO', 'dt_conclusao');
	define('ST_PRIORIDADE', 'st_prioridade');
	...
	define('AGENDA_PERFIL_SERVICE', 'AgendaPerfilService');
	define('AUDITORIA_SERVICE', 'AuditoriaService');
	define('CATEGORIA_SERVICE', 'CategoriaService');
	define('CODIGO_LIVRO_SERVICE', 'CodigoLivroService');
	define('CONTATO_SERVICE', 'ContatoService');
	define('EMPRESTIMO_SERVICE', 'EmprestimoService');
	...
	define('LIVRO_SERVICE', 'LivroService');
