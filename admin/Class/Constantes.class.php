...
class  Constantes
{
	...
	const SG_UF = 'sg_uf';
	const CO_EVENTO = 'co_evento';
	const NO_EVENTO = 'no_evento';
	const DS_CONTEUDO = 'ds_conteudo';
	const DS_PALAVRAS_CHAVES = 'ds_palavras_chaves';
	const DT_CADASTRO = 'dt_cadastro';
	const DS_LOCAL = 'ds_local';
	...
	const CO_INSCRICAO = 'co_inscricao';
	const DS_PASTORAL = 'ds_pastoral';
	const DS_RETIRO = 'ds_retiro';
	const DS_MEMBRO_ATIVO = 'ds_membro_ativo';
	const DS_SITUACAO_ATUAL_GRUPO = 'ds_situacao_atual_grupo';
	const NU_CAMISA = 'nu_camisa';
	const NO_RESPONSAVEL = 'no_responsavel';
	const NU_TEL_RESPONSAVEL = 'nu_tel_responsavel';
	const DS_DESCRICAO = 'ds_descricao';
	const CO_PESSOA = 'co_pessoa';
	const CO_MEMBRO = 'co_membro';
	const ST_ESTUDA = 'st_estuda';
	const ST_TRABALHA = 'st_trabalha';
	const DS_CONHECIMENTO = 'ds_conhecimento';
	const ST_BATIZADO = 'st_batizado';
	const ST_EUCARISTIA = 'st_eucaristia';
	const ST_CRISMA = 'st_crisma';
