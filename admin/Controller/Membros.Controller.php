...
//                debug($dados,1);
    ...
    function EditarMembroRetiro(){
        ...
        if(!empty($_POST[$id])):
            ...
            $dados['ds_retiro']             = Valida::retornoCheckbox((isset($dados['ds_retiro'])) ? $dados['ds_retiro'] : null);
            $dados['ds_pastoral_ativo']     = Valida::retornoCheckbox((isset($dados['ds_pastoral_ativo'])) ? $dados['ds_pastoral_ativo'] : null);
            $dados['st_pagamento']          = Valida::retornoCheckbox((isset($dados['st_pagamento'])) ? $dados['st_pagamento'] : null);
            $dados['ds_membro_ativo']       = Valida::retornoCheckbox((isset($dados['ds_membro_ativo'])) ? $dados['ds_membro_ativo'] : null);
            $dados['no_membro']             = trim($dados['no_membro']);
