...
//                debug($dados,1);
    ...
    function EditarMembroRetiro(){
        ...
        if(!empty($_POST[$id])):
            ...
            $dados['ds_retiro']             = Valida::retornoCheckbox($dados,'ds_retiro');
            $dados['ds_pastoral_ativo']     = Valida::retornoCheckbox($dados,'ds_pastoral_ativo');
            $dados['st_pagamento']          = Valida::retornoCheckbox($dados,'st_pagamento');
            $dados['ds_membro_ativo']       = Valida::retornoCheckbox($dados,'ds_membro_ativo');
            $dados['no_membro']             = trim($dados['no_membro']);
