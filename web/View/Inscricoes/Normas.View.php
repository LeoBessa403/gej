...
107%;font-family:&quot;Agency FB&quot;"><span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp; </span>É imensa a alegria em
                ...
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--justify"><span style="font-size:14.0pt;mso-bidi-font-size:11.0pt;line-height:-->
                <!--107%;font-family:&quot;Agency FB&quot;"><span style="mso-spacerun:yes">&nbsp;</span><span style="mso-tab-count:1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                ...
                <!--                        </span>-->
                <!--                        * Levar uma muda de roupa florida ou branca adequada; </span></p>-->
                <!---->
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--justify"><span style="font-size:14.0pt;mso-bidi-font-size:11.0pt;line-height:-->
                <!--107%;font-family:&quot;Agency FB&quot;"><span style="mso-tab-count:1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                <!--                        </span>* Além das demais roupas levar roupas confortáveis como leg, bermuda e regata para atividades <b>(apenas nos momentos permitidos)</b></span></p>-->
                <!---->
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--justify"><span style="font-size:14.0pt;mso-bidi-font-size:11.0pt;line-height:-->
                <!--107%;font-family:&quot;Agency FB&quot;">&nbsp;</span></p>-->
                ...
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--                justify"><span style="font-size:14.0pt;mso-bidi-font-size:11.0pt;line-height:-->
                <!--107%;font-family:&quot;Agency FB&quot;">- <b>Autorização assinada pelo responsável para os menores de 18 anos</b></span></p>-->
                <!---->
                <!---->
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--                justify"><b style="mso-bidi-font-weight:normal"><span style="font-size:14.0pt;-->
                ...
                <!--                            de shorts ou bermudas e Camisas Regatas ou blusas de alça (Com exceção nos momento permitidos).</b> </span></p>-->
                <!---->
                <!--                <p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;text-align:-->
                <!--justify"><span style="font-size:14.0pt;mso-bidi-font-size:11.0pt;line-height:-->
                <!--107%;font-family:&quot;Agency FB&quot;">&nbsp;</span></p>-->
